...
return [
    ...
    'Yes' => 'はい',
    'Error' => 'エラー',
    'Welcome to ClaritusCORE' => 'ClaritusCOREへようこそ',
    ...
    'Add New'=>'新しく追加する',
    'Permission Name'=>'権限の名前',
    'Permission Type'=>'パーミッション・タイプ',
    'Description'=>'説明',
    'Relative Url'=>'相対URL',
    'Select Parent'=>'選択親',
    'Select Type'=>'選択タイプ',
    'If relative url field left blank. This menu item will not be clickable.!'=>'相対URLフィールドは空白のままの場合。このメニュー項目はクリックできません。！',
    'Template Management'=>'テンプレート管理',
    'Manage Permission'=>'アクセス許可を管理します',
    ...
    'Admin Management'=>'管理者の管理',
    'Lookup Management'=>'ルックアップ・マネジメント',
    'Mapping'=>'マッピング',
    'Settings'=>'設定',
    'Logs'=>'ログ',
    ...
    'Subscriber Management'=>'加入者管理',
    'Permission name cannot be blank.'=>'許可名は空白にすることはできません。',
    'Permission type cannot be blank.'=>'アクセス許可の種類は空白にすることはできません。',
    'Permission name is invalid.'=>'許可名が無効です。',
    'Invalid description.'=>'無効な説明',
    'Sort order must be a number.'=>'ソート順は、数値でなければなりません。',
    'Description should contain at most 255 characters.'=>'説明は、最大で 二五五 文字を含める必要があります。',
    'Permission name should contain at most 150 characters.'=>'許可名は、最大 一五零 / 〇* 文字を含める必要があります。',
    'Save'=>'セーブ',
    'Subscribers'=>'サブスクライバ',
    'Devices'=>'デバイス',
    ...
    'Enabled'=>'使用可能',
    'Disabled'=>'使用禁止',
    '-- Select Status --'=>'- 選択してステータス -',
    'Path'=>'パス',
    'Permissions'=>'パーミッション',
    'Templates'=>'テンプレート',
    'Masters'=>'マスターズ',
    'Role Mappings'=>'ロール・マッピング',
    'Admin'=>'管理者',
    'Lookups'=>'ルックアップ',
    
    
    'Manage Users'=>'ユーザーの管理',
    'Version 2.3.0'=>'バージョン にてんさん',
    'Copyright &copy; 2015-2016 Claritus.'=>'著作権＆コピー;にせんじゅうご-にせんじゅうろく Claritus。',
