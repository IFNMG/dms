...
$this->title = \yii::t('app', 'Manage Country');
...
<!-- <div class="container"> -->
    ...
    <section class="content-header">
        <h1>
           <?php echo \yii::t('app', 'Manage Country');?>
    ...
    <section class="content">
        <div class="box box-default">
            <div class="box-header with-border">
                ...
                echo Html::a(\yii::t('app', 'Add'), Yii::$app->urlManager->createUrl(["index.php/adminuser/country/create"]), ['class' => 'btn btn-success btn-flat pull-left col-lg-1', 'name' => 'create']);                
                } ?>
            </div>
            <div class="box-body">
               ...
               <table id="listing-table" class="table table-hover">
                <thead><tr>
                  ...
                  <th><?php echo \yii::t('app', 'ISO Code');?></th>                  
               ...
               <tr id="tr_<?= $v['id'];?>">
                  ...
                  <td>
                    <select class="form-control" onchange="activateDeactivate(<?php echo $v['id'];?>, '<?php echo Yii::$app->getUrlManager()->createUrl(["index.php/adminuser/country/changestatus"]); ?>', this.value,'dd')">
                        <?php 
                        if($statusList) {
                 ...
                 <?php if($permission->view == 1 || $permission->edit == 1 || $permission->delete == 1){ ?> 
                  <td>
                     ...
                     <?= Html::a(\yii::t('app', 'View'), Yii::$app->urlManager->createUrl(["index.php/adminuser/country/view",'id'=>$v['id']])); ?>                
                     <?php } ?>
                     <?php if($permission->edit == 1){ ?> &nbsp;|&nbsp;
                     <?= Html::a(\yii::t('app', 'Edit'), Yii::$app->urlManager->createUrl(["index.php/adminuser/country/update",'id'=>$v['id']])); ?>                
                     <?php } ?>
                     <?php if($permission->delete == 1){ ?> &nbsp;|&nbsp;                      
                        <a style="cursor: pointer;" onclick="permanentDelete(<?php echo $v['id']?>, '<?php echo Yii::$app->getUrlManager()->createUrl(["index.php/adminuser/country/delete"]); ?>', this);">  
