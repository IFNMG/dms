    ...
    <section class="content">
        <div class="box box-default">
            <div class="box-header with-border">
                <?php 
                if($permission->add == 1){ 
                echo Html::a(\yii::t('app', 'Add'), Yii::$app->urlManager->createUrl(["index.php/adminuser/city/create"]), ['class' => 'btn btn-success btn-flat pull-left col-lg-1', 'name' => 'create']); 
                }?>
            </div>
            <div class="box-body">
               ...
               <table id="listing-table" class="table table-hover">
                ...
                <tr id="tr_<?= $v['id'];?>">
                  ...
                  <td>
                      <select class="form-control" onchange="activateDeactivate(<?php echo $v['id'];?>, '<?php echo Yii::$app->getUrlManager()->createUrl(["index.php/adminuser/city/changestatus"]); ?>',  this.value,'dd')">
                        <?php 
                        if($statusList) {
                  ...
                  elseif($permission->change_status == 1 && $countStatusList==2){ 
                      ...
                      ?>
                  <td><input id="toggle-event_<?= $v['id'];?>" type="checkbox" <?=($v['status']=='550001')?'checked':''?> id="toggle-event" data-toggle="toggle" data-on="Enabled" data-off="Disabled" data-style="ios" onchange="activateDeactivate(<?php echo $v['id'];?>, '<?php echo Yii::$app->getUrlManager()->createUrl(["index.php/adminuser/city/changestatus"]); ?>', <?=$changeTo?>,'')"></td>
                  <?php }
                  else{?>
                  ...
                  <td>
                     <?php if($permission->view == 1){ ?>                     
                      <?= Html::a(\yii::t('app', 'View'), Yii::$app->urlManager->createUrl(["index.php/adminuser/city/view",'id'=>$v['id']])); ?>                                   
                       <?php } ?>
                     <?php if($permission->edit == 1){ ?>    &nbsp;|&nbsp;
                     <?= Html::a(\yii::t('app', 'Edit'), Yii::$app->urlManager->createUrl(["index.php/adminuser/city/update",'id'=>$v['id']])); ?>                                      
                     <?php } ?>
                      <?php if($permission->delete == 1){ ?>&nbsp;|&nbsp;
                      <a style="cursor: pointer;" onclick="permanentDelete(<?php echo $v['id']?>, '<?php echo Yii::$app->getUrlManager()->createUrl(["index.php/adminuser/city/delete"]); ?>', this);">  
