    ...
    <section class="content">
        <div class="box box-default box-my ">
            ...
            <div class="box-footer">
                <?php if($model[0]['id']){?>
<?php echo Html::a(\yii::t('app', 'Go Back'), Yii::$app->urlManager->createUrl(["index.php/adminuser/city/"]), ['class' => 'btn btn-success btn-flat pull-left', 'name' => 'go-back']); ?>
                <?php echo Html::a(\yii::t('app', 'Edit'), Yii::$app->urlManager->createUrl(["index.php/adminuser/city/update/",'id'=>$model[0]['id']]), ['class' => 'btn btn-primary btn-flat pull-right', 'name' => 'edit-city-button']); ?>
                <?php }?>
            </div>
        </div><!-- /.box -->
    </section><!-- /.content -->
