               ...
               <table class="table table-hover" id="listing-table">
                <thead>
                    <tr>
                        ...
                        <th><?php echo \yii::t('app', 'Group Name')?></th>
                ...
                <tbody>
                    ...
                    <tr id="tr_<?php echo $list->id;?>">
                        ...
                        <td>
                            ...
                            <a href="<?php echo Yii::$app->getUrlManager()->createUrl(["index.php/dms/group/view", 'Id'=>$list->id]); ?>">
                            ...
                            <?php if($permission->view == 1){ ?>
                            <a href="<?php echo Yii::$app->getUrlManager()->createUrl(["index.php/dms/group/add", 'Id'=>$list->id]); ?>">
                                <?php echo \yii::t('app', 'Add Member')?>
                            </a>
                            <?php } ?>
