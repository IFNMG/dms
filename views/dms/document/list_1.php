    ...
    <section class="content">
        <div class="box box-default">
            ...
            <div class="box-header with-border">
                ...
                <a class="btn btn-success btn-flat pull-left col-lg-1" href="<?php echo Yii::$app->getUrlManager()->createUrl(["index.php/dms/document/add"]); ?>" class="btn btn-primary btn-flat pull-right">
            ...
            <div class="box-header with-border">
                ...
                <div style="padding: 15px 0px 0px 20px;" class="row">
                    ...
                    <div class="col-lg-2 form-group agreement" style="width: 15%;">
                        ...
                        <?php                            
                        if($vendorList) {
                            echo "<option value=''>".\Yii::t('app', '-- Select Vendor --')."</option>";
                    ...
                    <a id="viewList" style="padding:3px 12px; margin-top: 28px; " class="btn btn-info btn-sm">Search</a>
                    <a onclick="reset();" style="padding:3px 12px; margin-top: 28px; " class="btn btn-info btn-sm">Reset</a>
                </div>
                    ...
                    <table id="example" class="display" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo \Yii::t('app', 'Vendor');?></th>
