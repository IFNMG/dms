...
<link href='https://fonts.googleapis.com/css?family=Roboto+Condensed:400,300,400italic,700,700italic' rel='stylesheet' type='text/css'>
    ...
    ?>
    <body class="hold-transition skin-blue layout-top-nav <?=$class_fix;?>" style="background:#f5f5f5;">
        <div class="wrapper">
                    ...
                    <div class="container">
                        ...
                        ?>
                            ...
                            <style>
                                ...
                                #myLogoutButton a span {
                                    display: block;
                                    text-align: center;
                                    width: 100%;
                                }
                                #myLogoutButton .user-body {
                                    padding: 0 10px;
                                }
                            </style>
                            <li class="dropdown user user-menu user-my" id="myLogoutButton">
                                <!-- Menu Toggle Button -->
